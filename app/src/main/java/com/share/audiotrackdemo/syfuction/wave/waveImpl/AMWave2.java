...
public class AMWave2 extends Wave {
    private InputStream calibrationFile;
    ...
    public AMWave2(int freq, int carrierFreq, double depth, InputStream calibrationFile) {
        this.calibrationFile = calibrationFile;
        this.freq = freq;
    ...
    public double[] GetRawWaveBuffer(double DB) throws Exception {
        ...
        // 根据目标音量级别调整振幅
        double amplitude = LoudnessCalibrationUtil.getDb(68, freq, DB);
